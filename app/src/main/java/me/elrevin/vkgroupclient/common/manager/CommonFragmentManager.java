package me.elrevin.vkgroupclient.common.manager;
...
/**
 * Created by elrevin on 09.09.2017.
 */

public class CommonFragmentManager {
    private final static int EMPTY_FRAGMET_STACK_SIZE = 1;
    ...
    public boolean removeFragment(BaseActivity activity, BaseFragment fragment) {
        boolean canRemove = (fragment != null && mFragmentStack.size() > EMPTY_FRAGMET_STACK_SIZE);
